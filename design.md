...
Profile
CSS
Tailwind Frontend supported by Jinja2
Javascript
Facilitate canvas to decorate pizza, ingredient interactions, site component animations
Backend
Database (Through SQLite3)
Python backend handling updates and requests
Posts DB
Stores post ID, pizza, tags, and likes
User login DB
Stores username, PW
Pizzas DB
Stores pizza you made and love!
Toppings and Sauce DB will be used along with this
Flask Functionality (Through Jinja2)
Python backend handling routing
