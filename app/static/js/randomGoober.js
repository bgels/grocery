const options = {
    ...
    eyes:        ['eyes-special', 'eyes-sideways', 'eyes-evil', 'eyes-joyful', 'eyes-sleepy'],
    mouth:       ['mouth-p', 'mouth-line', 'mouth-o', 'mouth-3'],
    accessories: ['accessories-brownHat', 'accessories-necklace', 'accessories-hair1']
};
