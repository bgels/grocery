...
#### Visit our live site at [http://nocoupon.works/](https://nocoupon.works/)
...
>4) Navigate to root of repo `grocery/` via: [`cd ..`] (2x) to prepare for installation of dependencies
